...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # - It takes an object an gives a reference to that object
    #   to every iteration of the Block
  end
  ...
  # - Because with the open block syntax the File is closed automatically
