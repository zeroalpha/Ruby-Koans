...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # - Never ! even an empty string contains everything zero times
  end
  ...
  #
  # Why?
  # - Because they try to span the match as far as possible
  ...
  # - With alternation you could for example alternate character classes
  #   An Alteration matches a group OR a different Group whilst character
  #   classes match ANY character of the class
