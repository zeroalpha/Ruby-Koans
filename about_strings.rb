...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # Because it modifies the String in Place instead of creating a new instance
    # And not creating a new String instance really does make a performance difference
  end
